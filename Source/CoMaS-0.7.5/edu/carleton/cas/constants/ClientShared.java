...
public class ClientShared {
  ...
  public static void setupURLs(String course) {
    ...
    if (course != null) {
      String defaultHost = configs.getProperty(String.valueOf(course) + ".hostname", defaultGlobalHost);
  ...
  public static void updateURLs() {
    ...
    CLIENT_LOGIN_CONFIGURATION_URL = String.valueOf(BASE_CMS) + "exam" + "/" + "client.ini";
  ...
  public static Properties getClientLoginProperties(String course, String token) {
    ...
    if (configs == null) {
      ...
      PASSKEY_DIRECTORY = Utils.getStringOrDefault(configs, "passkey.directory", "SimpleDirectory");
      PASSKEY_LOG = Utils.getStringOrDefault(configs, "passkey.log", "LoggerService");
      PASSKEY_VIDEO = Utils.getStringOrDefault(configs, "passkey.video", "VideoService");
      PASSKEY_FILE_UPLOAD = Utils.getStringOrDefault(configs, "passkey.file_upload", "UploadFileService");
      PASSKEY_EXAM = Utils.getStringOrDefault(configs, "passkey.exam", "Exam");
    } 
    return configs;
  }
}
