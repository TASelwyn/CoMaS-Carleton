...
public abstract class AbstractFileTask extends AbstractTask {
  ...
  protected static ArrayList<String> IGNORE_TYPES;
  ...
  public boolean isIllegal(String line) {
    ...
    if (line.endsWith("comas-system-log.html"))
      return false; 
    if (line.endsWith("comas-base-log.html"))
      return false; 
  ...
  public static void configure(Properties properties) {
    ...
    i = 1;
    ftype = properties.getProperty("monitor.file.ignore." + i);
    while (ftype != null) {
      ftype = ftype.trim();
      if (!IGNORE_TYPES.contains(ftype))
        IGNORE_TYPES.add(ftype); 
      i++;
      ftype = properties.getProperty("monitor.file.ignore." + i);
    } 
  }
