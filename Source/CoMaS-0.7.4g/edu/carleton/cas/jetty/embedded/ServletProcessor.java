...
public class ServletProcessor implements Runnable, Closeable {
  ...
  public static class MultipleChoiceQuestionServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      FileInputStream fis = new FileInputStream(String.valueOf(Shared.getExamDirectory(ServletProcessor.instance.course, ServletProcessor.instance.activity)) + name);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if (questionFileName == null || questionFileName.length == 0) {
        ...
        PrintWriter answerFile = new PrintWriter(
            String.valueOf(Shared.getExamDirectory(ServletProcessor.instance.course, ServletProcessor.instance.activity)) + File.separator + questionFileName[0] + ".txt");
